...
resource "aws_lambda_function" "auth_challenge_functions" {
  for_each         = local.auth_challenge_functions
...
resource "aws_lambda_function" "sign_up_functions" {
  for_each         = local.sign_up_functions
  function_name    = each.key
...
resource "aws_lambda_permission" "auth_challenge" {
  for_each      = local.auth_challenge_functions
